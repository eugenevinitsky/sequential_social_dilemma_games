...
ray exec ray_autoscale.yaml "python sequential_social_dilemma_games/run_scripts/train_moa.py --training_iterations 100000 --num_cpus 100 \
--exp_name moa_harvest --use_s3 --num_agents 5 --exp_name reproduce_test --env harvest --algorithm A3C --num_envs_per_worker 1" --cluster-name=hparam_sweep --start --stop
